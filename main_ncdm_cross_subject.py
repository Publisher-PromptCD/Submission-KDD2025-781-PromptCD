...
Source_item2knowledge = {}   #记录练习题和知识点的映射关系
Source_knowledge_set = set() #记录知识点数量
...
Target_item2knowledge = {}   #记录练习题和知识点的映射关系
Target_knowledge_set = set() #记录知识点数量
...
s_train_set, s_test_set = [
    transform2(data["user_id"], data["item_id"], Source_item2knowledge, data["score"], batch_size,s_knowledge_n,pp_dim)
    for data in [Source_train, Source_test]
]

t_train_set, t_val_set, t_test_set = [
    transform2(data["user_id"], data["item_id"], Target_item2knowledge, data["score"], batch_size, t_knowledge_n,pp_dim)
